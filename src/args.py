...
def parse_arguments():
    ...
    parser.add_argument("--train_nums", default=405, type=int, help="number of training images.")
    parser.add_argument("--val_nums", default=45, type=int, help="number of valid images.")
