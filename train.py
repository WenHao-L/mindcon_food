...
from src.data import FoodImageDataset
...
def train(args):
    ...
    # 加载数据集
    food_dataset = FoodImageDataset(args=args)
    train_dataset = food_dataset.train_dataset
    val_dataset = food_dataset.val_dataset
    ...
    # 定义递减的学习率
    lr = nn.cosine_decay_lr(min_lr=0.00005, max_lr=0.001, total_step=args.epochs * step_size,
